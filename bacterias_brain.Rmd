...
# fit function
b_q3 <- nls(novick_b$concentration ~ growth_b3(t, ampl, tau), data = novick_b, start = list(ampl = 5, tau = 10))
...
# fit function
b_q4 <- nls(novick_b$concentration ~ growth_b4(t, beta, tau), data = novick_b, start = list(beta = 5, tau = 10))
