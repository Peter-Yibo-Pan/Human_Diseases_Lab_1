...
```{r fit_function_A}
#define function
growth_a <- function (t, ampl, tau) (ampl*(1-t/tau))
#fit function
nls(novick_a$concentration ~ growth_a(novick_a$time, myA, myT), data = novick_a, start = list(myA = 1.26, myT = 2.62))
...
coefficients <- lm(b_q2$concentration ~ b_q2$time)
